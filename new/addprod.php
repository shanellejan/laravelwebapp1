...
<div id="content">
 ...
 <form action="saveimage.php" enctype="multipart/form-data"class="addprodform" method="post" autocomplete="off">
 

	<a href="#.php"><text class="btn1" style="float: left; color:white"/>Add</a>
	<a href="updateprodform.php"><text class="btn1" style="float: left; color:white"/>Update</a>
