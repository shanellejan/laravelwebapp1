...
<head>
	...
	<title>Polly Lagyap - Customization</title>
	<meta charset="UTF-8">
					...
					$result = mysql_query($query);
						...
						{                        
								$row = mysql_fetch_array($result);
									...
									echo "<form action = 'savecustomization.php' method = 'POST'>";	
									echo '<div class="product-content"><h3>'.$row["customization_no"].'</h3>';
									echo '<div class="product-content"><h3>'.'Type: '.$row["type"].'</h3>';
									echo '<div class="product-content"><h3>'.'Bust: '.$row["bust"].'</h3>';
									echo '<div class="product-content"><h3>'.'Waistline: '.$row["waistline"].'</h3>';
									echo '<div class="product-content"><h3>'.'Hips: '.$row["hips"].'</h3>';
									echo '<div class="product-content"><h3>'.'Figure: '.$row["figure"].'</h3>';
									echo '<div class="product-content"><h3>'.'Shoulder: '.$row["shoulder"].'</h3>';
									echo '<div class="product-content"><h3>'.'Arm Length: '.$row["armlength"].'</h3>';
									echo '<div class="product-content"><h3>'.'Skirt Length: '.$row["skirtlength"].'</h3>';
									echo '<div class="product-content"><h3>'.'Description: '.$row["description"].'</h3>';
									
									echo '<div class="product-info">  
									<br><br><input style="width: 400px; float: right" type = "submit"  value = <a href = "emailcon.php" </a>"ARE YOU SURE OF THIS MEASUREMENTS?" class = "btn3">
