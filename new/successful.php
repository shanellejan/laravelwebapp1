...
<body>
	...
	<center>
 	...
 	<text style="font-size: 26px;">An email confirmation will be sent after 5-10 days <br> for the complete billing details </text>
	<text style="font-size: 26px;"><br><br>CHAO!</text></center>
	</div>
